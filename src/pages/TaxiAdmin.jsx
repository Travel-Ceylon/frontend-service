...
export function TaxiAdmin() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 max-w-screen">
      ...
      <div className="max-w-screen xl:mx-12 mx-4 px-6 -mt-8 relative z-10">
        <div className="flex items-end space-x-6">
          ...
          <img
            ...
            alt="Driver"
            className="sm:w-40 sm:h-40 w-32 h-32 rounded-full border-4 border-white object-cover shadow-lg"
          />
          {/* Vehicle info */}
          <div className="pb-4">
      ...
      {/* TAB NAVIGATION */}
      <div className=" max-w-screen xl:mx-18 mx-8  mt-8 mb-8">
        <div className="flex space-x-1 justify-between bg-white rounded-md">
          {tabs.map((tab) => (
            <button
              key={tab}
